...
#### Naive Bayes
```{r}
censusNaive <- naiveBayes(Over_50k ~ . , data=na.omit(training))

actual <- na.omit(testing)$Over_50k
predictions <- predict(censusNaive, na.omit(testing), type="raw")[,2]
