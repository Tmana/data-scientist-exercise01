...
print(p6)
```
The large majority of individuals have a full 40 hours a week listed, and there are a larger proportion of 50k earners for hours worked above 40 than those below.
...
levels(testing) = list(HS_or_less = c(1, 3, 8), undergrad = c(2, 4), graduate = 5:7)
levels(training) = list(HS_or_less = c(1, 3, 8), undergrad = c(2, 4), graduate = 5:7)
```
